...
export const onboardingPrompt = ({
  system,
}: OnboardingParams) => `You are viewing the project for the first time.
...
export const thinkAboutTaskAdherencePrompt =
...
export const thinkAboutWhetherYouAreDonePrompt =
...
export const prepareForNewConversationPrompt = ({
  modePrepareForNewConversation,
}: PrepareForNewConversationParams) => `You have not yet completed the current task but we are running out of context.
${modePrepareForNewConversation}
