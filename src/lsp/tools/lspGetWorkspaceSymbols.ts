...
export const lspGetWorkspaceSymbolsTool: ToolDef<typeof schema> = {
  ...
  schema,
  execute: async (_args) => {
    // TODO: Fix workspace symbols search - currently fails with "No Project" error in tsserver
    // This feature is temporarily disabled until we resolve the project initialization issue
    throw new Error(
      "Workspace symbols search is temporarily disabled. This feature requires proper project initialization which is not yet implemented.",
    );
