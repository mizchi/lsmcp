...
import { createLSPTool } from "../client/toolFactory.ts";
// Removed external dependency - fileSymbolResolver should be provided by consumer
import { DiagnosticResultBuilder } from "../lsp-utils/resultBuilders.ts";
import {
  getActiveClient,
