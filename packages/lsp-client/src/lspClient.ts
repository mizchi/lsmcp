...
import { applyWorkspaceEditManually } from "./workspaceEditHandler.ts";
...
import { getLanguageIdFromPath } from "./utils/container-helpers.ts";
...
import { getServerCharacteristics } from "./utils/container-helpers.ts";
import { nodeFileSystemApi } from "./utils/container-helpers.ts";

// Deprecated: Import from globalClientManager instead
import {
  getActiveClient as _getActiveClient,
  setActiveClient as _setActiveClient,
  getLSPClient as _getLSPClient,
  shutdown as _shutdown,
} from "./globalClientManager.ts";

/**
 * @deprecated Use getActiveClient from globalClientManager
 */
export const getActiveClient = _getActiveClient;

/**
 * @deprecated Use setActiveClient from globalClientManager
 */
export const setActiveClient = _setActiveClient;

/**
 * @deprecated Use getLSPClient from globalClientManager
 */
export const getLSPClient = _getLSPClient;

/**
 * @deprecated Use shutdown from globalClientManager
 */
export const shutdown = _shutdown;

/**
 * @deprecated Use initialize from globalClientManager with createLSPClient
 */
export async function initialize(
  ...
  fileSystemApi?: import("./interfaces/index.ts").IFileSystem,
): Promise<LSPClient> {
  const { initialize: globalInitialize } = await import(
  ...
  return globalInitialize(client);
}
